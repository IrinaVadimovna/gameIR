...
const mainScreen = '<header class="header_play header_none"><div class="timer timer_block"><div class="timer_name timer"><p class="timer timer_name">min</p><p class="timer timer_name">sek</p></div><p class="timer_time">00.00</p></div></header><div class="error_block"></div><section class="center play"><div class="screen"><h1 class="screen-title">Выбери сложность</h1><div class="level"><div class="number-level" data-level="simply"><p class="level-text">1</p></div><div class="number-level" data-level="middle"><p class="level-text">2</p></div><div class="number-level" data-level="hard"><p class="level-text">3</p></div></div><p class="text">*Вы сможете допустить 3 ошибки</p><button class="start-button">Старт</button></div></section>';
const winScreen = '<section class="center play"><div class="screen"><img class="img_status" src="./img/win.svg" alt="победа"><h1 class="screen-title status_title">Вы выиграли!</h1><p class="time_status">Затраченное время:</p><p class="time_status time"></p><button class="start-button again-button">Играть снова</button></div></section>';
const lossScreen = '<section class="center play"><div class="screen"><img class="img_status" src="./img/loss.svg" alt="проигрыш"><h1 class="screen-title status_title">Вы проиграли!</h1><p class="time_status">Затраченное время:</p><p class="time_status time"></p><button class="start-button again-button">Играть снова</button></div></section>';
...
//запусить таймер
//вывести данные таймера на экран статуса игры
